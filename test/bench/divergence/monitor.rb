...
test "Streams are out of tolerance" do
  stream_name_1 = StreamMetricsTelemetry::Controls::Divergence::Writer.write 1, 'stream_1'
  stream_name_2 = StreamMetricsTelemetry::Controls::Divergence::Writer.write 1, 'stream_2'
